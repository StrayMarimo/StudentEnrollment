...
class TeachersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create teacher" do
    assert_difference("Teacher.count") do
      post teachers_url, params: { teacher: { department_name: @teacher.department_name, name: @teacher.name } }
    end
  ...
  test "should update teacher" do
    patch teacher_url(@teacher), params: { teacher: { department_name: @teacher.department_name, name: @teacher.name } }
